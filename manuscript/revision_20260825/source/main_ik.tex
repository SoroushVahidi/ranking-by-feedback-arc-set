...
Family-aware analysis shows that SpringRank comparisons remain family-sensitive, and BTL (and corrected RankCentrality) remain stronger on \texttt{upset\_ratio} (\S\ref{subsec:family_aware}).
