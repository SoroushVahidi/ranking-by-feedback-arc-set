...
Table~\ref{tab:reviewer1_stage_ablation} reports \texttt{upset\_simple}, \texttt{upset\_naive}, \texttt{upset\_ratio}, and mean runtime across three pipeline stages, on matched dataset support.
...
\midrule
Phase~A only (A0) & 0.2571 & 93621.2 & 0.3762 & 0.148 \\
+ legacy fixed-topological/\textsc{ins} reinsertion (A1) & 0.2555 & 93589.0 & 0.3760 & 0.276 \\
+ legacy refinement, full pipeline (A3) & 0.2521 & 93548.8 & 0.3462 & 0.378 \\
\bottomrule
\end{tabular}
