...
|---|---|---|---|---|---|---|
| Suite 80 / readable 79 / exclude `_AUTO` | `outputs/derived/dataset_inventory.csv` | `in_80_suite` | 80 intended; 79 readable | — | missing files excluded | — |
...
| Coverage 77/79, 78/79, 61/79 | `e2_coverage_matrix.csv` / `CLASSICAL_RUNTIME_FINAL.md` | method rows | 79 readable | — | success/timeout/N/A | — |
