...
Use the canonical paper-artifact pipeline and outputs under the repository-level `outputs/` area (for example `outputs/paper_tables/` and `outputs/audits/`). Do not cite values from this legacy folder for current manuscript claims.
