...
def parameter_parser():
    ...
    parser.add_argument('--SavePred', '-SP', action='store_true', default=False,
                        help='Whether to save predicted labels.')
    parser.add_argument('--AllTrain', '-All', action='store_true', default=False,
    ...
    if args.all_methods == ['all_methods_shorter']:
        args.all_methods = [
            ...
            'OURS_MFAS_INS1','OURS_MFAS_INS2','OURS_MFAS_INS3',
            'DIGRAC', 'ib'
        ]
